...
App::App(const std::string& cmdString)
    ...
    , _theRenderer{std::make_unique<Renderer>(*_theFileLogger.get(), static_cast<unsigned int>(currentGraphicsOptions.WindowWidth), static_cast<unsigned int>(currentGraphicsOptions.WindowHeight)) }
